...
import { StyledContainer, StyledEmptyState, StyledTestCard, StyledTestStatus } from './styles';
...
export function UserBloodTestsView({ bloodTests, onTestSelect }: UserBloodTestsViewProps) {
  return (
    <StyledContainer>
      ...
      {bloodTests.length === 0 ? (
        <StyledEmptyState>No blood tests found</StyledEmptyState>
      ) : (
