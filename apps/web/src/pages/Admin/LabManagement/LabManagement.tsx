...
export function LabManagement() {
  ...
  const columns: Column<Lab>[] = [
    ...
    },
    {
      ...
      cell: (row) => (
        <FlexRow $gap="sm">
          <Button $variant="secondary" $size="small" onClick={() => setReferencesLabId(row.id)}>
            <Icons.Settings size="sm" />
          </Button>
          <Button $variant="secondary" $size="small" onClick={() => openEdit(row)}>
            <Icons.Edit size="sm" />
          </Button>
          <Button $variant="secondary" $size="small" onClick={() => handleDelete(row.id)}>
            <Icons.Trash size="sm" />
          </Button>
        </FlexRow>
      ),
