...
export function BiomarkerModal({ biomarker, categories, onClose, onSave }: BiomarkerModalProps) {
  ...
  // This modal is mounted only while open, so the trap is always active here.
  ...
  return (
    <StyledModalOverlay onClick={handleOverlayClick}>
      <StyledModalContent
        ...
        role="dialog"
        aria-modal="true"
        aria-label={biomarker ? 'Edit Biomarker' : 'Create New Biomarker'}
      >
        <StyledModalHeader>
        ...
        <StyledModalBody>
          <form onSubmit={handleSubmit}>
            <StyledFormGrid>
              ...
              <Paragraph $size="small" $variant="secondary" $mt="sm">
